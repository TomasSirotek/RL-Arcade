...
[games/mario/game.py](../games/mario/game.py) stacks wrappers:
...
- **FrameStack(4)** (added in `core/vec.py`) — one still frame can't show whether Mario is rising or falling. Stacking gives the network motion.
